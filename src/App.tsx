...
const MODELS=[
  ...
  {id:"sponsorship",name:"Sponsorship & Media",tag:"Climbing brands pay for sponsored challenges, athlete content, and audience access. App is free",icon:"users",color:T.green,colorLight:T.greenLight,who:"Climbing brands, sponsors",what:"Challenges, content, partnerships",excl:"Only brand partnership revenue.",desc:"App free. Revenue from sponsored challenges, branded leaderboards, pro athlete content, native ads.",
